...
import { Eye, EyeOff, Mail, Lock, Zap, ChartNoAxesColumn } from "lucide-react";
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <ChartNoAxesColumn className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                <Input
                  id="name"
                  name="name"
                  type="text"
